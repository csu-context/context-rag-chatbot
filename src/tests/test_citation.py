...
def run_test():
    ...
    docs1 = [
        Document(
            page_content="내용1", metadata={"src_name": "manual.pdf", "pg_num": 5}
        ),
        Document(
            page_content="내용2", metadata={"src_name": "guide.docx", "pg_num": 10}
        ),
    ]
    ...
    docs2 = [
        ...
        Document(
            page_content="내용2", metadata={"src_name": "manual.pdf", "pg_num": 5}
        ),
    ]
    ...
    docs3 = [
        ...
        Document(
            page_content="내용2", metadata={"src_name": "no_page.pdf"}
        ),  # pg_num 없음
    ]
