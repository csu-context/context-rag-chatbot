...
> **평가 방법**: Option B — Docling 도입 타당성 정량 평가  
...
| 지표 | PyMuPDF | Docling | 차이 | 승자 |
|------|--------:|--------:|-----:|:----:|
| **파싱 시간 (초)** | 0.058 | 109.2 | ×1,883배 | PyMuPDF ✅ |
| **한글 문자 수 (자)** | 39,661 | 39,867 | +206 (+0.5%) | Docling ✅ |
| **총 텍스트 길이 (자)** | 81,846 | 120,600 | +38,754 (+47.3%) | Docling ✅ |
| **표 감지 개수** | 0 | 34 | +34 | Docling ✅✅ |
| **표 마크다운 변환율** | 0% | 100% | +100%p | Docling ✅✅ |

### 3.2 파싱 시간 5회 원시 데이터

| 회차 | 측정 시각 | PyMuPDF (초) | Docling (초) |
|:----:|-----------|-------------:|-------------:|
...
```json
{
  ...
  "parsers": {
    "pymupdf": {
      "parse_time_avg_sec": 0.0584,
      "parse_time_std_sec": 0.001,
      "korean_chars": 39661,
      "text_length": 81846,
      "table_count": 0
    },
    "docling": {
      "parse_time_runs_sec": [114.63, 108.53, 97.20, 105.10, 120.34],
      "parse_time_avg_sec": 109.16,
      "parse_time_std_sec": 8.4,
      "korean_chars": 39867,
      "text_length": 120600,
      "table_count": 34,
      "cache_reuse_sec": 0.1
...
*리포트 생성일: 2026-05-17*  
*데이터 소스: `reports/benchmark_*.json` (5개 파일), `logs/ingestion_docling_err.log`*
